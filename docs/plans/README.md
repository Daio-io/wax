...
**Active plan:** None — order 7 (generic registry discovery protocol) is **complete**. Post-alpha UX (order 5) remains deferred until the roadmap reopens.
...
Orders 1–4, 6, and 7 are **complete**. Post-alpha UX (order 5) remains deferred. See [`archive/README.md`](./archive/README.md) and [`docs/adr/`](../adr/README.md) for prior implementation records.
