...
| Task | Command / check |
|------|-----------------|
| 2 | `scripts/test-wax-scan-extract-insights.sh` |
| 3 | `scripts/test-wax-scan-html-escape.sh`, `scripts/render-wax-scan-fixture-report.sh` + manual offline HTML open smoke |
| 5 | `scripts/test-wax-scan-integration-smoke.sh` |
