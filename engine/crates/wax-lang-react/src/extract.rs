...
use swc_ecma_ast::{
    AssignTarget, BinaryOp, BlockStmt, BlockStmtOrExpr, Callee, Class, ClassMember, Decl,
    DefaultDecl, ExportSpecifier, Expr, ForHead, Function, JSXAttrOrSpread, JSXAttrValue,
    JSXElement, JSXElementChild, JSXElementName, JSXExpr, JSXFragment, JSXMemberExpr, JSXObject,
    Key, MemberProp, ModuleDecl, ModuleExportName, ModuleItem, Pat, Prop, PropName, PropOrSpread,
    SimpleAssignTarget, Stmt, VarDecl, VarDeclOrExpr, VarDeclarator,
};
use wax_contract::{
