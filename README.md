...
- [Registry discovery design](docs/plans/2026-06-04-registry-discovery-design.md) and [implementation plan](docs/plans/2026-06-04-registry-discovery-plan.md) — in-progress next phase for `wax registry discover` and skill-assisted registry sync (order 4)
