...
| React v1.1 | Resolver depth | Re-export chains, barrel files, package `exports`, monorepo workspace packages, `tsconfig` auto-detection, Vite/Webpack alias hints, clearer unresolved-import reporting. |
