...
use wax_lang_api::{
    RootResolutionError, normalize_repo_relative_path, path_matches_any, resolve_source_roots,
    root_not_found_code, root_not_found_message,
};
...
mod tests {
    use super::*;
    use std::fs;
    use wax_lang_api::path_matches_glob;
