...
| Task | Command / check |
|------|-----------------|
| 2 | `scripts/wax-scan/test-extract-insights.sh` |
| 3 | `scripts/wax-scan/test-html-escape.sh`, `scripts/wax-scan/render-fixture-smoke.sh` + manual offline HTML open smoke |
| 5 | `scripts/wax-scan/test-integration-smoke.sh` |
