...
| 9 | Interactive init wizard | [2026-06-13-interactive-init.md](./2026-06-13-interactive-init.md) | `merged` | `in-progress` | — |
...
```text
IF order 9 implementation is not complete
  -> execute Task 1 from 2026-06-13-interactive-init.md
